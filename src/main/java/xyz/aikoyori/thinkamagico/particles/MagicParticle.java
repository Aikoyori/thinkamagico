...
@OnlyIn(Dist.CLIENT)
public class MagicParticle extends SimpleAnimatedParticle {


    private MagicParticle(ClientWorld world, double x, double y, double z, double motionX, double motionY, double motionZ, IAnimatedSprite spriteWithAge) {
        super(world, x, y, z, spriteWithAge, 0.0f);
        this.motionX = motionX;
        this.motionY = motionY;
        this.motionZ = motionZ;
        this.particleScale *= 1.5F;
        this.maxAge = 1+this.rand.nextInt(12);
